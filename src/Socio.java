...
public final class Socio {
    ...
    /**
     * Lista los nombres de todos los socios usando map y forEach
     */
    public static void listarNombresSocios(List<Socio> socios) {
        socios.stream()
                .map(Socio::getNombre)
    ...
    public String toString() {
        return String.format("Socio{nombre='', cedula='', cuentas=}",
